...
},{"./Observer.js":"node_modules/gsap/Observer.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
...
var playVideoIcon = document.querySelector('.play-button');
var poster = document.querySelector('.poster');
var startVideo = document.querySelector('.air-quality-video');
var statsBackground = document.querySelector('.background-stats');
function sleep(ms) {
  return new Promise(function (resolve) {
...
var moveToSlide = function moveToSlide(currentSlide, targetSlide, slideWidth, dir) {
  if (dir == "back") {
    _gsap.default.to(targetSlide, {
      duration: .01,
      x: 0,
      ease: 'power4.out'
    });
    _gsap.default.from(targetSlide.children[2], {
      duration: 1.3,
      x: -1000,
      ease: 'circ.out'
    });
...
_gsap.default.to(statsBackground, {
  scrollTrigger: {
    scrub: 1
  },
  y: 0
